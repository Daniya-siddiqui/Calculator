...
function OpenScientificLayout() {
    if (isOpen) {
        ...
        document.getElementById("result").style.width = "73%";
        ...
        document.getElementById("result").style.width = "88%";
...
function formatData(){
    // let formatData = requestData.reduce((acc,value) => {
    //     if(!acc[value.en_no]){
    //         acc[value.en_no] = []
    //     }
    //     acc[value.en_no].push(value)
